...
function Contact() {
  return (
    <section className="mb-32 bg-gray-100">
      ...
      <div className="flex flex-wrap">
        <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
          <form>
            ...
            <div className="relative mb-6" data-te-input-wrapper-init>
              <textarea
                  className="peer block min-h-[auto] w-full rounded border-2  py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none "
            ...
            <button type="button"
                className="mb-6 w-full  rounded bg-[#321497] text-white p-5  font-medium  uppercase leading-normal   lg:mb-0">
                Send
              </button>
          </form>
        </div>
            ...
            <div
              ...
              <div className="align-start flex">
                  ...
                  <div className="inline-block rounded-md bg-sky-200 p-4 text-primary">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                     xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" className="w-7 h-7"
                      viewBox="0 0 111.756 122.879" enableBackground="new 0 0 111.756 122.879" xmlSpacee="preserve">
                      <g>
                        <path
                ...
                <div className="ml-6 grow">
                  ...
                  <p className="text-neutral-500"> (+233) 558 487 942
                  </p>
                </div>
              </div>
            </div>
